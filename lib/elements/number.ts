...
import { clear, figures, lines, style } from "../util";
...
export class NumberPrompt extends Prompt {
	 ...
	 * @param opts Options
	 */
	constructor(opts?: NumberPromptOptions) {
		opts ??= {} as NumberPromptOptions;
		super(opts);
...
export type NumberValidateFunction = (
	input: number
